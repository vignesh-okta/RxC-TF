...
ok_groups = {
"RxC_PROD_PORTAL_BetaPlusManufacturer_EXT" = {
...
oidc_apps = {
  "BBPPortalApp" = {
  redirect_urls = ["https://www.portal.betaseron.com"]
  bookmark_app_url = "https://www.portal.betaseron.com"
  label  = "Actor ID"
  dataType = "string"
  required = "false"
...
org_whitelist_url = ["https://www.portal.betaseron.com"]
