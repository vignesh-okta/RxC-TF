...
ok_groups = {
  "RxC_PROD_PORTAL_FreseniusManufacturer_EXT" = {
...
oidc_apps = {
  "FreseniusPortalApp" = {
  redirect_urls = ["https://www.velphoroaccesssolution.com"]
  bookmark_app_url = "https://www.velphoroaccesssolution.com"
  label  = "Actor ID"
  dataType = "string"
  required = "false"
...
org_whitelist_url = ["https://www.velphoroaccesssolution.com"]
